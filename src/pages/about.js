...
const About = (props) => {
	...
	return (
		<>
			...
			<p>
				Blandit aliquam etiam erat velit scelerisque in. Ante in nibh mauris
				cursus mattis. Sed risus ultricies tristique nulla. Sagittis vitae et
				Leo duis ut. Condimentum id venenatis a condimentum vitae sapien.
				Commodo ullamcorper a lacus vestibulum sed arcu. Egestas quis ipsum
				suspendisse ultrices gravida dictum fusce ut. Dui faucibus in ornare
				quam viverra. Neque egestas congue quisque egestas diam in. Arcu ac
				tortor dignissim convallis aenean et tortor at. Aliquet sagittis id
